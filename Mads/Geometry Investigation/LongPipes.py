...
root_univ = openmc.Universe(cells=[cell_fuel,cell_zirc,cell_blanket,cell_steelClad,cell_carbSteel,cell_air,cell_blastShield,cell_vacuum])#,cell_carbSteel,cell_air,cell_blastShield,cell_vacuum
