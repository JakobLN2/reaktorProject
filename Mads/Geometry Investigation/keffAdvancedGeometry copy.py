...
def makeFuel(rho,g_per_kgU,enrichment,fuel_id =None):
        ...
        mUSO4 = openmc.data.atomic_weight("S") + 6*openmc.atomic_mass("O16")+mU
        ...
        fuel.add_element('S', percent=USO4_num_frac/8,percent_type="ao")
        fuel.add_element("O",percent=6*USO4_num_frac/8+D2O_num_frac/3,percent_type="ao")
...
np.savez("BasicBallData",batches = batches, k_gen = k_gen)
