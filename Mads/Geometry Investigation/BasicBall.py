...
carbSteelGeometry = -openmc.Sphere(r=rCarbSteel,boundary_type = "vacuum")
...
root_univ = openmc.Universe(cells=[cell_fuel,cell_zirc,cell_blanket,cell_steelClad,cell_carbSteel])#,cell_carbSteel,cell_air,cell_blastShield,cell_vacuum
